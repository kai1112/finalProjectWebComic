...
module.exports.viewPaginationManga = async (req, res) => {
    try {
        ...
        if (listManga) {
            res.render('pages/admin/viewMangaAuthorPost/viewMangaAuthorPostEjs/viewpaginationMangaAuthorPost', { total, listAuthor, listManga })
        } else {
...
module.exports.HomePage = async (req, res) => {
    try {
        ...
        let listManga = await MangaModel.find().sort({ views: 'desc' }).limit(10);
